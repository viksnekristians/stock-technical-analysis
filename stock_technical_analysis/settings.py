"""
Django settings for stock_technical_analysis project.
...
env = environ.Env()  # Initialize the environ module
...
SECRET_KEY = 'django-insecure-&+n8w5(al$@9edb*ao$w@##$8w13f2(lo0uo-@933m(s8#bj76'
...
ROOT_URLCONF = 'stock_technical_analysis.urls'
...
WSGI_APPLICATION = 'stock_technical_analysis.wsgi.application'
